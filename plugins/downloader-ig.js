...
const handler = async (m, {conn, args, command, usedPrefix}) => {
  if (!args[0]) throw `*[❗اشعار❗] يرجى إرسال رابط منشور إنستجرام. مثال: ${usedPrefix + command} https://www.instagram.com/reel/Cc0NuYBg8CR/?utm_source=ig_web_copy_link*`;
  m.reply(global.wait);
  try {
...
handler.command = /^(instagramdl|انستجرام|انستا|ig|instagramdl2|instagram2|igdl2|ig2|instagramdl3|instagram3|igdl3|ig3)$/i;
