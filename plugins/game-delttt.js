...
if (room == undefined) return await conn.reply(m.chat, `${lenguajeGB['smsAvisoFG']()}لا يوجد غرفة اكس او في هذه الدردشه\n\n💫 لبدء اللعب (${usedPrefix}ttt sala nueva)`, fkontak, m)
...
await conn.reply(m.chat, `${lenguajeGB['smsAvisoEG']()}تم إنهاء اللعبة في الغرفة`, fkontak, m)}
...
handler.command = /^(delttt|حذف|delxo|deltictactoe)$/i
handler.fail = null
