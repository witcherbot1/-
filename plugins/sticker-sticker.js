...
const handler = async (m, {conn, args, usedPrefix, command}) => {
  ...
  try {
    ...
    if (/webp|image|video/g.test(mime)) {
      ...
      if (!img) throw `*[❗اشعار❗] رجاءً قم بالرد على صورة أو فيديو لتحويلها إلى ملصق. استخدم أمر ${usedPrefix + command}*`;
      let out;
      try {
      ...
      else return m.reply('*[❗اشعار❗] المدخلات غير صالحة. قم بالرد على صورة أو فيديو أو استخدم رابط مباشر للصورة. مثال:  ${usedPrefix}s https://telegra.ph/file/d879cbad22d59e9f6c94d.jpg*');
    }
  } catch (e) {
    console.error(e);
    if (!stiker) stiker = e;
    ...
    else throw '*[❗اشعار❗] حدث خطأ أثناء تنفيذ الأمر. الرجاء المحاولة مرة أخرى أو استخدام الأمر في بيئة عربيه*';
  }
};
handler.help = ['sfull'];
