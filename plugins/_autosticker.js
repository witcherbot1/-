...
handler.all = async function(m) {
  ...
  if (chat.autosticker && m.isGroup) {
    ...
    if (/image/g.test(mime)) {
      ...
      if (/video/g.test(mime)) if ((q.msg || q).seconds > 8) return await m.reply(`*[❗𝐈𝐍𝐅𝐎❗] الفيديو لا يجب أن يتجاوز 7 ثواني*\n\nقم بتعديل الفيديو وإرساله مرة أخرى. (#𝚍𝚒𝚜𝚊𝚋𝚕𝚎 𝚊𝚞𝚝𝚘𝚜𝚝𝚒𝚌𝚔𝚎𝚛)`);
