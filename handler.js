...
export async function callUpdate(callUpdate) {
    ...
    let vcard = `BEGIN:VCARD\nVERSION:3.0\nN:;Al SoLtAn┇👑;;;\nFN:Al SoLtAn┇👑\nORG:Al SoLtAn┇👑\nTITLE:\nitem1.TEL;waid=201277272498 :+201277272498 \nitem1.X-ABLabel:Al SoLtAn┇👑\nX-WA-BIZ-DESCRIPTION:[❗] تكلم مع المطور اذا كان لديك مشكله ما.+201277272498 \nX-WA-BIZ-NAME:Al SoLtAn┇👑\nEND:VCARD`
    await this.sendMessage(nk.from, { contacts: { displayName: 'Al Soltan┇👑', contacts: [{ vcard }] }}, {quoted: callmsg})
...
global.dfail = (type, m, conn) => {
    ...
    let prep = generateWAMessageFromContent(m.chat, { extendedTextMessage: { text: msg, contextInfo: { externalAdReply: { title: '[ ⚠ ] -', body: '『👑┇┇🤖┇┇👑』', thumbnail: imagen1, sourceUrl: 'https://wa.me/+201277272498 ' }}}}, aa)
